...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="Swap.Ddd.Domain" Version="0.1.0-*" />
  </ItemGroup>
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="Swap.Ddd.Application.Contracts" Version="0.1.0-*" />
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="Swap.Ddd.Application" Version="0.1.0-*" />
    <PackageReference Include="Swap.EntityFrameworkCore" Version="0.1.0-*" />
...
<Project Sdk="Microsoft.NET.Sdk.Razor">
  ...
  <ItemGroup>
    <PackageReference Include="Swap.AspNetCore.Mvc" Version="0.1.0-*" />
    <PackageReference Include="Swap.Events" Version="0.1.0-*" />
...
""";
    ...
    private void CreateModuleJson(string moduleDir)
    {
        var moduleJson = new
        {
            ...
            {
                "Swap.Core >= 0.1.0",
                "Swap.Ddd.Domain >= 0.1.0",
                "Swap.Ddd.Application >= 0.1.0",
                "Swap.EntityFrameworkCore >= 0.1.0"
            },
            projects = new[]
            {
                new
...
<Project Sdk="Microsoft.NET.Sdk.Web">
  ...
  <ItemGroup>
    ...
    <PackageReference Include="FluentAssertions" Version="6.12.0" />
    <PackageReference Include="Swap.Testing" Version="*" />
  </ItemGroup>
