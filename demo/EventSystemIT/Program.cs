...
using EventSystemIT.Data.Seeders;
...
builder.Services.AddControllersWithViews(options =>
{
    ...
    options.ModelBinderProviders.Insert(0, new EventSystemIT.Infrastructure.InvariantDecimalModelBinderProvider());
});
...
if (isDocker)
{
    ...
    builder.Services.AddDataProtection()
        ...
        .SetApplicationName("EventSystemIT");
}
