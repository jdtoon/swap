        ...
        switch (tab) {
            ...
            case 'state':
                ...
                const stateContainers = document.querySelectorAll(
                    '[data-swap-state], [id$="-state"], [id$="-container"], #state-container, form'
                );
                ...
                if (Object.keys(state).length === 0) {
                    content.innerHTML = '<div style="padding:8px;color:#888;">No state containers found. Look for elements with id ending in "-state" or data-swap-state attribute.</div>';
                } else {
