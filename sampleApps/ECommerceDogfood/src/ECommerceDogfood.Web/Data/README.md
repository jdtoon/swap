...
```bash
# From the ECommerceDogfood.Web directory
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Host=localhost;Port=5432;Database=ecommercedogfood;Username=postgres;Password=postgres"
  }
}
```
...
Ensure you're running commands from the `ECommerceDogfood.Web` directory.
